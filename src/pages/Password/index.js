...
const Password = (props) => {
  ...
  const { isEditSuccess, isEditFailed } = useSelector((state) => state.user);
        ...
        <Fragment>
          ...
          <Container fluid="sm" className="d-flex mt-5 px-0 px-sm-5">
            ...
            <div className="content-main">
              ...
              <p className="text bold text-dark mb-4 d-none d-sm-inline">
                Change Password
              </p>
              <p
                style={{ width: "334px" }}
                className="text-muted mb-5  ml-3 ml-sm-0 text-password"
              >
              ...
              <div className="d-flex flex-column password-password">
                <div className="notes bg-transparent">
                  <img
                    className="edit"
                    src={currActive ? LockActive : Lock}
                    alt=""
                  />
                  <img
                    onClick={() => setCurrEye(!currEye)}
                    className="eye eye-password"
                    src={Eye}
                    alt=""
                  />
                  <input
                    onFocus={() => setCurrActive(true)}
                    onBlur={() => setCurrActive(false)}
                    onChange={(e) => setCurrPassword(e.target.value)}
                    value={currPassword}
                    className="note bg-transparent"
                    type={currEye ? "text" : "password"}
                ...
                <div className="notes bg-transparent">
                  <img
                    className="edit"
                    src={repeatActive ? LockActive : Lock}
                    alt=""
                  />
                  <img
                    onClick={() => setRepeatEye(!repeatEye)}
                    className="eye eye-password"
                    src={Eye}
                    alt=""
                  />
                ...
                <button
                  ...
                  className="py-3 btn-phone align-self-sm-center"
                >
                  Change Password
                </button>
              </div>
