    ...
    <Fragment>
      ...
      <Container className="d-flex mt-5">
        ...
        <div className="content-main d-flex flex-column align-items-center py-sm-5">
          ...
          <Link
            to={{ pathname: `/profile/info` }}
            style={style.label}
            className="label-profile mt-4 d-flex justify-content-between align-items-center"
          >
            <p className="bold med text-dark mb-0">Personal Information</p>
            <img src={ArrowRight} alt="arrow" />
          </Link>
          <Link
            to={{ pathname: `/profile/password` }}
            style={style.label}
            className="label-profile d-flex justify-content-between align-items-center"
          >
            <p className="bold med text-dark mb-0">Change Password</p>
            <img src={ArrowRight} alt="arrow" />
          </Link>
          <Link
            to={{ pathname: `/profile/pin` }}
            style={style.label}
            className="label-profile d-flex justify-content-between align-items-center"
          >
              ...
              <form onSubmit={onSubmit}>
                <div className="d-flex flex-column align-items-center mb-4">
                  ...
                  <input
                    ...
                    value={name}
                    style={{
                      borderBottom: "1px solid rgba(169, 169, 169, 0.6)",
                      borderRadius: 0,
                    }}
