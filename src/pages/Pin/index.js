...
const Pin = (props) => {
  ...
  if (!checkedPin) {
      ...
      <Fragment>
        ...
        <Container className="d-flex mt-5">
          ...
          <div className="content-main">
            ...
            <p style={{ width: "334px" }} className="text-muted mb-5">
              Enter your current 6 digits Zwallet PIN below to continue to the
              next steps.
            </p>
            <form
              onSubmit={handleSubmit(onSubmit)}
              className="d-flex flex-column justify-content-center align-items-center p-0 p-sm-3"
            >
              <div className="pin">
              ...
              <button
                style={buttonActive ? style.buttonPrimary : style.buttonGrey}
                type="submit"
                className="py-3 btn-phone"
              >
                Continue
              </button>
            </form>
    ...
    return <Redirect to="/profile/pin/new" />;
  }
};
